...
// ═══════════════════════════════════════════════════════════
// 1. GET /admin/stats — Overall admin statistics (ADMIN only)
// ═══════════════════════════════════════════════════════════
dashboardRouter.get(
  "/admin/stats",
  ...
  async (_req, res, next) => {
    try {
      ...
      sendResponse({
        ...
        data: {
          users: { total: totalUsers, learners: totalLearners },
          courses: {
            total: totalCourses,
            fixed: totalFixedCourses,
            batch: totalBatchCourses,
          },
          batches: { total: totalBatches, active: totalActiveBatches },
          enrollments: {
...
// ═══════════════════════════════════════════════════════════
// 2. GET /admin/revenue — Monthly revenue (last 12 months, ADMIN only)
// ═══════════════════════════════════════════════════════════
dashboardRouter.get(
  "/admin/revenue",
  roleMiddleware("ADMIN"),
...
// ═══════════════════════════════════════════════════════════
// 3. GET /admin/course-earnings — Earnings by course (ADMIN only)
// ═══════════════════════════════════════════════════════════
dashboardRouter.get(
  "/admin/course-earnings",
  roleMiddleware("ADMIN"),
  async (_req, res, next) => {
    try {
...
// ═══════════════════════════════════════════════════════════
// 4. GET /admin/batch-earnings — Earnings by batch (ADMIN only)
// ═══════════════════════════════════════════════════════════
dashboardRouter.get(
  "/admin/batch-earnings",
  roleMiddleware("ADMIN"),
  async (_req, res, next) => {
    try {
      const earnings = await prisma.order.groupBy({
...
// ═══════════════════════════════════════════════════════════
// 5. GET /admin/top-students — Most active learners (ADMIN only)
//    Query: ?limit=10
// ═══════════════════════════════════════════════════════════
dashboardRouter.get(
  "/admin/top-students",
...
// ═══════════════════════════════════════════════════════════
// 6. GET /admin/recent-activity — Recent activity (ADMIN only)
//    Query: ?limit=10
// ═══════════════════════════════════════════════════════════
dashboardRouter.get(
